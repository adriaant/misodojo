...
env.project_name = "misodojo"
env.prod_host = "misodojo.com"
env.dev_host = "misodojo.dev.especific.be"
env.repository = "git@github.com:adriaant/misodojo.git"
